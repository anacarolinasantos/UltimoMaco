...
class HealthInformationDB {
    static let healthInformations: [HealthInformationModel] = [
        ...
        HealthInformationModel.init(category: .health, information: "Se você parar de fumar agora: em 20 minutos, sua pressão arterial e a frequência do pulso voltam ao normal."),
        HealthInformationModel.init(category: .health, information: "Se você parar de fumar agora: em 2 horas, não haverá mais nicotina no seu sangue"),
        HealthInformationModel.init(category: .health, information: "Se você parar de fumar agora: em 8 horas, os níveis de monóxido de carbono no sangue chegam aos valores normais e o nível de oxigênio aumenta."),
        HealthInformationModel.init(category: .health, information: "Se você parar de fumar agora: em 24 horas, os pulmões já funcionam melhor e os brônquios começam a limpar os resíduos deixados pelo fumo."),
        HealthInformationModel.init(category: .health, information: "Se você parar de fumar agora: em 48 horas, o olfato já percebe melhor os cheiros e o paladar já degusta melhor a comida."),
        HealthInformationModel.init(category: .health, information: "Se você parar de fumar agora: dentro de 2 semanas a 3 meses, a circulação sanguínea melhora consideravelmente. Caminhar torna-se mais fácil e a função pulmonar melhora em até 30%."),
        HealthInformationModel.init(category: .health, information: "Se você parar de fumar agora: em 1 ano, o risco de doenças ligadas a males do coração, como infarto, cai pela metade."),
        HealthInformationModel.init(category: .health, information: "Se você parar de fumar agora: em 5 anos, diminui o risco de acidente vascular cerebral (AVC). Já o risco de infarto do miocárdio e morte por ataque cardíaco se aproxima daquele de quem nunca fumou."),
         HealthInformationModel.init(category: .health, information: "Se você parar de fumar agora: em 10 anos, o risco de sofrer um infarto será igual ao de quem nunca fumou. E haverá uma redução dos riscos de câncer na boca, garganta, esôfago, bexiga, rim e pâncreas."),
         HealthInformationModel.init(category: .health, information: "Se você parar de fumar agora: em 15 anos, o risco de desenvolver câncer de pulmão pode igualar-se ao dos não fumantes."),
         //Help informations
        ...
        HealthInformationModel.init(category: .fissure, information: "Procure comer alguma coisa com um gosto forte, como gengibre ")]
