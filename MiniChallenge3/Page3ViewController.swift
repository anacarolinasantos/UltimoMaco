...
class Page3ViewController: PageModelViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        // I've decideed to give the user up to 100 years of smoking.
        for i in 0...100{
            amount.append(i)
        }
    }
